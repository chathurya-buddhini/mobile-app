...
const BGImage = require('../assets/images/Frame 7 (2).png');
const IconImage = require('../assets/images/Fm.jpg');
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.overlayContainer}>
                ...
                <TouchableOpacity activeOpacity={0.8} style={styles.button} onPress={() => router.push('/Fmpage')}>
